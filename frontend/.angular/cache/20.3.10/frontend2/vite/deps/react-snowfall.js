...
var SnowfallCanvas = class {
  ...
  constructor(canvas, config) {
    ...
    __classPrivateFieldSet(this, _SnowfallCanvas_canvas, canvas, "f");
    __classPrivateFieldSet(this, _SnowfallCanvas_ctx, canvas.getContext("2d"), "f");
    this.config = __spreadValues(__spreadValues({ snowflakeCount: 150 }, defaultConfig), config);
    this.snowflakes = [];
...
var useSnowfallStyle = (overrides) => {
  const styles = (0, import_react.useMemo)(() => __spreadValues(__spreadValues({}, snowfallBaseStyle), overrides || {}), [overrides]);
  return styles;
};
